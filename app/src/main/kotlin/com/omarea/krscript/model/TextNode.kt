...
class TextNode(currentPageConfigPath: String) : NodeInfoBase(currentPageConfigPath) {
    ...
    class TextRow : Serializable {
        ...
        // Nếu true: kết quả (không rỗng) của "script"/"run" HOẶC "set"/onChangeSh (toggle) khi
        // bấm row được hiện bằng Toast ngắn gọn thay vì dialog log như mặc định. Khai báo bằng
        // "toast" trong TOML.
