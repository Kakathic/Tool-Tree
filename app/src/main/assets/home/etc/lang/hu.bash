...
directbg_text="Háttérkép kikapcsolása"
...
builds_text_8="Patch stílus választás"
builds_text_81="AVB foltozása az fstab-ban"
builds_text_82="Titkosítás javítása (fileencryption, keydirectory, ...)"
builds_text_83="install-recovery.sh törlése"
...
warn_gemini_text="A Gemini API hitelesítése sikertelen, adja hozzá az API-kulcsot itt: Beállítások > Funkciók > API-kulcs"
chat_gemini_text="Csevegés a Geminivel"
chatai_think_text="Gondolkodási szint"
chatai_rule_text="Szabályok alkalmazása"