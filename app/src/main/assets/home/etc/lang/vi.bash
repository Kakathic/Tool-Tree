...
project_text_12="Thiết lập luồng CPU"
...
builds_text_8="Lựa chọn kiểu vá"
builds_text_81="Vá avb ở fstab"
builds_text_82="Vá mã hóa (fileencryption, keydirectory, ...)"
builds_text_83="Xoá install-recovery.sh"
...
warn_gemini_text="Xác thực API Gemini thất bại, thêm mã khóa tại: Cài đặt > Tính năng > Mã khoá API"
chat_gemini_text="Trò chuyện với Gemini"
chatai_think_text="Mức độ suy nghĩ"
chatai_rule_text="Áp dụng qui tắc"
